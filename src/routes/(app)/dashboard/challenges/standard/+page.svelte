...
<ResultModal bind:modalOpen {wordsPerMinute} {duration} {accuracy} on:next={handleNext} on:repeat={handleRepeat} />

{#if loading}
	<div class="h-full flex justify-center items-center">
		<div role="status">
			<svg aria-hidden="true" class="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-sky-700" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
